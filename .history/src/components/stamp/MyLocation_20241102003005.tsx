        ...
        <>
          <div className="flex flex-col gap-[8px]">
            ...
            <input
              ...
              className="rounded-[12px] border border-[#B5B5B5] bg-transparent py-[20px]"
            />
          </div>
          <Link href={'/stamp-all'}>
            <button
              className={`bg-secondary-500 w-full rounded-[12px] px-[42px] py-[50px] font-semiBold text-[20px] text-[#004157] ${visit && 'animate-fadeUpBtn'}`}
            >
              스탬프 확인하러 가기
            </button>
          </Link>
